...
final class Cache_Enabler_Disk {
    ...
    public static function cache_iterator( $url, $args = array() ) {
        ...
        uksort( $cache['index'], array( self::class, 'sort_dir_objects' ) );
    ...
    private static function converter( $page_contents ) {
         ...
         * @param  string  $page_contents  Page contents from the cache engine as raw HTML.
         */
        $converted_page_contents = (string) apply_filters( 'cache_enabler_page_contents_after_webp_conversion', preg_replace_callback( $image_urls_regex, array( self::class, 'convert_webp' ), $page_contents ) );
